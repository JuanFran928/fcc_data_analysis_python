...
df.loc[((df['weight']/(df['height']**2)) < 25) , 'overweight'] = 0
...
def draw_cat_plot():
    ...
    df_cat.columns = [*df_cat.columns[:-1], 'total']
...
#https://forum.freecodecamp.org/t/medical-data-visualizer-confusion/410074/5
